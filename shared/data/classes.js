...
export const JOBS = {
  swordman: {
    id: 'swordman', nameTh: 'นักดาบ', nameEn: 'Swordman',
  ...
  mage: {
    id: 'mage', nameTh: 'นักเวทย์', nameEn: 'Mage',
  ...
  archer: {
    id: 'archer', nameTh: 'นักธนู', nameEn: 'Archer',
    ...
    attack: { kind: 'physical', style: 'projectile', range: 260, cooldown: 560, mult: 0.95, mpCost: 0, projectile: 'arrow', speed: 360 },
  },
  boxer: {
    id: 'boxer', nameTh: 'นักมวยไทย', nameEn: 'Muay Thai Boxer',
