...
| F หรือ ↓ | คุยกับ NPC (ร้านค้าป้าติ๋ม) |
| M | เปิด/ปิดเสียง |
...
| อาชีพ | Q | W | E | R |
|---|---|---|---|---|
| ขุนศึก | ฟันสะบั้น | พุ่งทะลวง | ดาบวายุ | พายุดาบพันเล่ม |
| จอมขมังเวทย์ | ลูกไฟสามลูก | อัสนีบาต | เกราะยันต์ | ฝนดาวตก |
| พรานป่า | ยิงสองดอก | ศรทะลวง | ฝนธนู | ตาเหยี่ยว |
| นักมวยคาดเชือก | หมัดชุด | เตะก้านคอ | เข่าลอย | ไหว้ครูรำมวย |
